import { PrepareEthErc20SignedOffchainTransaction, PrepareEthSignedOffchainTransaction, TransactionKMS, TransferEthErc20Offchain, TransferEthOffchain } from '../model';
/**
 ...
 */
export declare const prepareEthSignedOffchainTransaction: (prepareEthSignedOffchainTransaction: PrepareEthSignedOffchainTransaction) => Promise<{
    txData: string;
 ...
 */
export declare const prepareEthErc20SignedOffchainTransaction: (prepareEthErc20SignedOffchainTransaction: PrepareEthErc20SignedOffchainTransaction) => Promise<{
    txData: string;
    gasLimit: string | number;
}>;
