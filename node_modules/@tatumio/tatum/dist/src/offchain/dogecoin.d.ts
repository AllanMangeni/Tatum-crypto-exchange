 ...
 */
export declare const sendDogecoinOffchainTransaction: (testnet: boolean, body: TransferBtcBasedOffchain) => Promise<{
    id: string;
    txId: string;
    completed: boolean;
} | {
 ...
 * @returns transaction data to be broadcast to blockchain.
 */
export declare const prepareDogecoinSignedOffchainTransaction: (testnet: boolean, data: WithdrawalResponseData[], amount: string, address: string, mnemonic?: string | undefined, keyPair?: KeyPair[] | undefined, changeAddress?: string | undefined, multipleAmounts?: string[] | undefined, signatureId?: string | undefined) => Promise<any>;
